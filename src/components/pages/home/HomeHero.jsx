      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16 xl:gap-20">
          <div className="min-w-0 text-left">
            ...
            >
              <Hexagon className="h-3.5 w-3.5 shrink-0 text-brand-cyan sm:h-4 sm:w-4" aria-hidden strokeWidth={2} />
            ...
            >
              {heroCopy.titleLine1}{' '}
              <span className="text-brand-gold-light">{heroCopy.titleAccent}</span>
            </motion.h1>
            ...
            >
              ...
              >
                ...
                >
                  {heroCopy.primaryCta}
                  <ArrowRight className="h-5 w-5 shrink-0" aria-hidden strokeWidth={2.25} />
                </Link>
              </motion.div>
              <motion.a
                href="#"
                ...
                aria-label={`${heroCopy.secondaryCta} (coming soon)`}
              >
                <Play className="h-5 w-5 shrink-0 text-white" aria-hidden strokeWidth={2} />
              ...
              {heroTrustBadges.map((item) => (
                <li key={item.title} className="flex min-w-0 items-start gap-3">
                  <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-brand-gold/25 bg-brand-gold/8">
                    <item.icon className="h-5 w-5 text-brand-gold-light" aria-hidden strokeWidth={1.35} />
                  </span>
                  <div className="min-w-0 pt-0.5">
                    <p className="text-sm font-semibold leading-snug text-white sm:text-[0.9375rem]">{item.title}</p>
                    <p className="mt-1 text-xs leading-relaxed text-brand-ink-muted sm:text-sm">{item.sub}</p>
                  </div>
                </li>
              ))}
            </motion.ul>
          ...
          <motion.div variants={itemVariants} className="min-w-0 lg:justify-self-end">
            <HomeHeroVisual />
          </motion.div>
        </div>
      </div>
