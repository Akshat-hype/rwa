...
const footerColumns = {
  ...
  legal: [
    ...
    { name: 'Risk Disclosure', href: '/about' },
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-12 py-14 sm:py-16 lg:grid-cols-12 lg:gap-10 lg:py-16">
          <div className="lg:col-span-3">
            <Link to="/" className="inline-flex max-w-full" aria-label="Billion Towers home">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 lg:col-span-6 lg:gap-6">
            {columnOrder.map((key) => (
              <div key={key}>
                <h3 className="text-sm font-bold text-white">{sectionLabel[key]}</h3>
