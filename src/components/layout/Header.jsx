        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between lg:h-20">
            ...
            <div className="hidden items-center space-x-4 lg:flex">
              <motion.button
                type="button"
                className="p-2 text-brand-ink-secondary transition-colors hover:text-brand-cyan"
              ...
              <motion.button
                type="button"
                className="relative p-2 text-brand-ink-secondary transition-colors hover:text-brand-cyan"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
              >
                <Bell className="h-5 w-5" />
                <span className="absolute -right-1 -top-1 h-3 w-3 animate-pulse rounded-full bg-brand-gold" />
              </motion.button>
          ...
          <>
            ...
            >
              <div className="mx-auto flex max-w-lg flex-col gap-1 pb-6">
                ...
                <button
                  type="button"
                  className="flex min-h-[48px] items-center gap-3 rounded-xl px-4 py-3 text-left text-brand-ink-secondary hover:bg-brand-cyan/10 hover:text-brand-cyan"
                >
                ...
                <button type="button" className="btn btn-neon mt-2 flex min-h-[52px] w-full items-center justify-center gap-2">
                  <Wallet className="h-4 w-4" />
                  <span>Connect Wallet</span>
                </button>
              </div>
